...
CREATE TABLE `users` (
    ...
    `connectedServerId` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_connectedServerId_fkey` FOREIGN KEY (`connectedServerId`) REFERENCES `servers`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
